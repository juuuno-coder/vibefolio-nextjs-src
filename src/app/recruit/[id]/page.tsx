  ...
  if (!item) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50">
        <p className="text-xl font-bold text-slate-400 mb-4">항목을 찾을 수 없습니다.</p>
        <Button onClick={() => router.push('/recruit')}>목록으로 돌아가기</Button>
      </div>
    );
  }
            ...
            <div className="sticky top-28 space-y-6">
              <div className="p-8 md:p-10 rounded-[48px] bg-slate-900 text-white shadow-2xl shadow-slate-200 space-y-8 relative overflow-hidden">
                ...
                <div className="pt-6 border-t border-slate-800 space-y-4 relative z-10">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-400 font-medium">조회수</span>
                    <span className="font-bold">1,240</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-400 font-medium">제보일</span>
                    <span className="font-bold">2024.01.07</span>
                  </div>
                </div>
              </div>

              {/* Tips or related content placeholder */}
              <div className="p-8 rounded-[40px] bg-white border border-slate-100 shadow-sm space-y-4">
                ...
                <p className="text-sm text-slate-500 font-medium leading-relaxed">
                  이 공모전은 포트폴리오의 실전 감각을 익히기에 아주 좋은 기회입니다. 
                  기획 의도를 명확히 파악하고 트렌디한 감각을 더해보세요!
                </p>
              </div>
            </div>
          </div>
