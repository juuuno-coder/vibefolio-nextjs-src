            ...
            {commentsPanelOpen && (
              <div className="w-[22vw] h-full bg-white flex flex-col border-l border-gray-200 ml-4 rounded-t-xl overflow-hidden shadow-xl animate-in slide-in-from-right duration-500">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-white custom-scrollbar">
                   {/* [Premium] System Activity Messages - Refactored to Comment Style */}
                   <div className="space-y-4 mb-6 relative before:absolute before:left-3.5 before:top-2 before:bottom-2 before:w-px before:bg-gray-100">
                      
                      {/* 1. Private Inquiry */}
                      <div className="relative pl-10">
                         <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-purple-100 flex items-center justify-center ring-4 ring-white">
                            <FontAwesomeIcon icon={faPaperPlane} className="w-3 h-3 text-purple-600" />
                         </div>
                         <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-1">
                               <span className="text-xs font-black text-gray-900">System</span>
                               <span className="px-1.5 py-0.5 bg-purple-100 text-purple-600 text-[9px] font-bold rounded uppercase tracking-tighter">PRIVATE INQUIRY</span>
                               <span className="text-[10px] text-gray-300 font-medium ml-auto">방금 전</span>
                            </div>
                            <p className="text-xs text-gray-600 leading-relaxed">비밀 제안을 받았습니다 🔒</p>
                         </div>
                      </div>

                      {/* 2. New Update */}
                      <div className="relative pl-10">
                         <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center ring-4 ring-white">
                            <FontAwesomeIcon icon={faRocket} className="w-3 h-3 text-blue-600" />
                         </div>
                         <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-1">
                               <span className="text-xs font-black text-gray-900">Project</span>
                               <span className="px-1.5 py-0.5 bg-blue-100 text-blue-600 text-[9px] font-bold rounded uppercase tracking-tighter">NEW UPDATE</span>
                               <span className="text-[10px] text-gray-300 font-medium ml-auto">1시간 전</span>
                            </div>
                            <p className="text-xs text-gray-600 leading-relaxed">새 에피소드를 배포했어요 🚀</p>
                         </div>
                      </div>

                      {/* 3. Sticker Feedback */}
                      <div className="relative pl-10">
                         <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-pink-100 flex items-center justify-center ring-4 ring-white">
                             <FontAwesomeIcon icon={faFaceSmile} className="w-3 h-3 text-pink-600" />
                         </div>
                         <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-1">
                               <span className="text-xs font-black text-gray-900">Anonymous</span>
                               <span className="px-1.5 py-0.5 bg-pink-100 text-pink-600 text-[9px] font-bold rounded uppercase tracking-tighter">STICKER</span>
                               <span className="text-[10px] text-gray-300 font-medium ml-auto">2시간 전</span>
                            </div>
                            <p className="text-xs text-gray-600 leading-relaxed">응원 스티커를 남겼습니다 💖</p>
                         </div>
                      </div>

                      {/* 4. Rating Feedback */}
                      <div className="relative pl-10">
                         <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-amber-100 flex items-center justify-center ring-4 ring-white">
                             <FontAwesomeIcon icon={faStar} className="w-3 h-3 text-amber-600" />
                         </div>
                         <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-1">
                               <span className="text-xs font-black text-gray-900">Critic</span>
                               <span className="px-1.5 py-0.5 bg-amber-100 text-amber-600 text-[9px] font-bold rounded uppercase tracking-tighter">RATING</span>
                               <span className="text-[10px] text-gray-300 font-medium ml-auto">3시간 전</span>
                            </div>
                            <p className="text-xs text-gray-600 leading-relaxed">평점 피드백을 남겼습니다 ⭐</p>
                         </div>
                      </div>

                       {/* 5. Secret Comment Reference (Hidden style) */}
                      <div className="relative pl-10 opacity-60">
                         <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-gray-100 flex items-center justify-center ring-4 ring-white">
                             <FontAwesomeIcon icon={faLock} className="w-3 h-3 text-gray-400" />
                         </div>
                         <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-1">
                               <span className="text-xs font-black text-gray-500">Unknown</span>
                               <span className="text-[10px] text-gray-300 font-medium ml-auto">하루 전</span>
                            </div>
                             <p className="text-xs text-gray-400 italic">비밀 댓글입니다.</p>
                         </div>
                      </div>
                   </div>
