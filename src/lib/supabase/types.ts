  ...
  public: {
    Tables: {
      ...
      recruit_items: {
        ...
        Insert: { id?: number; title: string; description: string; type: string; date: string; location?: string | null; prize?: string | null; salary?: string | null; company?: string | null; employment_type?: string | null; link?: string | null; thumbnail?: string | null; is_active?: boolean; created_at?: string; };
        Update: { id?: number; title?: string; description?: string; type?: string; date?: string; location?: string | null; prize?: string | null; salary?: string | null; company?: string | null; employment_type?: string | null; link?: string | null; thumbnail?: string | null; is_active?: boolean; created_at?: string; };
        Relationships: [];
      };
